  ...
  return (
    <div className="featured">
      <div className="featuredItem">
        ...
        <span className="featuredSub">Amount / Compared to last month</span>
      </div>
      <div className="featuredItem">
      ...
      <div className="featuredItem">
        <span className="featuredTitle">Direct Players</span>
        <div className="featuredMoneyContainer">
        ...
        <span className="featuredSub">Number / Compared to last month</span>
      </div>
      <div className="featuredItem">
